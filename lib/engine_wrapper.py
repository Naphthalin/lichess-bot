...
from lib.engine_wrapper_leela import leela_init_engine_wrapper, leela_search, leela_store_verbose_move_stats
...
class EngineWrapper:
    ...
    def __init__(self, options: OPTIONS_GO_EGTB_TYPE, draw_or_resign: Configuration) -> None:
        ...
        leela_init_engine_wrapper(self)
    ...
    def play_move(self,
        ...
        leela_store_verbose_move_stats(self, engine_cfg, game, best_move, board)
...
class UCIEngine(EngineWrapper):
    ...
    def search(self, board: chess.Board, time_limit: chess.engine.Limit, ponder: bool, draw_offered: bool,
        ...
        return leela_search(self, board, time_limit, ponder, draw_offered, root_moves)
